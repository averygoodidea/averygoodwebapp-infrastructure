...
| authUser     | `<authUser>` | Generate an authUser string value from [Random.org](https://www.random.org/strings/?num=1&len=20&digits=on&upperalpha=on&loweralpha=on&unique=on&format=html&rnd=new) Then Base64 this string at https://www.base64encode.net/. Be sure to then store this string in a safe place, like [lastpass.com](lastpass.com). |
